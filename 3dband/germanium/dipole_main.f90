        ...
        if (nky<=int(para(2))) then
            ...
            if (nky<=nkx.and.nkx<=int((para(1)-1)).and.nkx<=para(3)) then
                ...
                if (0<=moji.and.moji<=0.01d0) then
                    ...
                    para(4)=para(4)+P**2*abs(eigenv(i,1)*eigenv(j,6))**2
                    if (0.000<=eigenv(i,3).and.0.000<=eigenv(j,6)) then
                    para(4)=para(4)+P1**2*abs(eigenv(i,3)*eigenv(j,6))**2  
                    if (0.000<=eigenv(i,1).and.0.000<=eigenv(j,8)) then
                    para(4)=para(4)+P2**2*abs(eigenv(i,3)*eigenv(j,6))**2  
                    if (0.000<=eigenv(i,3).and.0.000<=eigenv(j,8)) then
                    para(4)=para(4)+P3**2*abs(eigenv(i,3)*eigenv(j,6))**2  
                    if (0.000<=eigenv(i,1).and.0.000<=eigenv(j,2)) then
                    para(4)=para(4)+Q**2*abs(eigenv(i,3)*eigenv(j,6))**2  
                    if (0.000<=eigenv(i,3).and.0.000<=eigenv(j,2)) then
                    para(4)=para(4)+Q1**2*abs(eigenv(i,3)*eigenv(j,6))**2  
                    if (0.000<=eigenv(i,1).and.0.000<=eigenv(j,7)) then
                    para(4)=para(4)+R**2*abs(eigenv(i,3)*eigenv(j,6))**2 
                    if (0.000<=eigenv(i,3).and.0.000<=eigenv(j,7)) then
                    para(4)=para(4)+R1**2*abs(eigenv(i,3)*eigenv(j,6))**2 
                    if (0.000<=eigenv(i,5).and.0.000<=eigenv(j,2)) then
                    para(4)=para(4)+T**2*abs(eigenv(i,3)*eigenv(j,6))**2 
                    if (0.000<=eigenv(i,4).and.0.000<=eigenv(j,2)) then
                    para(4)=para(4)+T1**2*abs(eigenv(i,3)*eigenv(j,6))**2 
                    end if
                    end if
                    end if
                    end if
