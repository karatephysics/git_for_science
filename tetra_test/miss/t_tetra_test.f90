subroutine tetra_apex_output(nkx,nky,nkz,tetra1,tetra2,tetra3,tetra4,tetra5,tetra6,vol_tetra)
...
do i=1,6
!   write(12,'(2i10,f8.4)') nkx,i,vol_tetra(i)
end do

do ss=1,4
!   write(18,'(3f8.4)') tetra1(1,ss),tetra1(2,ss),tetra1(3,ss)
end do
...
do ss=1,4
   do ind=1,2
      ...
      ene_tetra1(ss,ind)=energy(ind)*13.6d0
      write(*,*) ene_tetra1(ss,ind)
   end do
end do
